...
{  
   glCompressedTexImage2DARB  = ( PFNGLCOMPRESSEDTEXIMAGE2DARBPROC  ) 
                //  GetProcAddress("glCompressedTexImage2DARB");
                 // glXGetProcAddress("glCompressedTexImage2DARB"  );
                   //wglGetProcAddress ( "glCompressedTexImage2DARB"  ); //Profe
   glGetCompressedTexImageARB = ( PFNGLGETCOMPRESSEDTEXIMAGEARBPROC )
                //  GetProcAddress("glCompressedTexImage2DARB");

                 // glXGetProcAddress("glGetCompressedTexImageARB" );
